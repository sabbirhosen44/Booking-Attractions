...
# Upserts a DataFrame into an Iceberg table
...
# Appends a DataFrame to an Iceberg table with no conflict handling
def append(df, table):
    if df.rdd.isEmpty():
        return
...
# Updates specific columns on an existing Iceberg table from an updates
# DataFrame
